...
public class NormalSeekBar extends View {
    ...
    public NormalSeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void drawPop(Canvas canvas) {
        ...
        float currentX = width / 2 * progress / 100 + startX;
        ...
        //绘制指示器中间的文字
        progress = (int) ((currentX - startX) / width * 2 * 100);
        ...
        //绘制中心点和指示器的连线
        canvas.drawLine(startX, startY, currentX, startY, paintAccent);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        progress = (int) ((pointX - startX) / width * 2 * 100);
        if (callBack != null) {
